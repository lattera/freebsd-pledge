...
struct sysent sysent[] = {
	...
	{ AS(sysctl_args), (sy_call_t *)sys___sysctl, AUE_SYSCTL, NULL, 0, 0, SYF_PLEDGE_ALWAYS | SYF_CAPENABLED, SY_THR_STATIC },	/* 202 = __sysctl */
	...
	{ AS(cap_getmode_args), (sy_call_t *)sys_cap_getmode, AUE_CAP_GETMODE, NULL, 0, 0, SYF_PLEDGE_ALWAYS | SYF_CAPENABLED, SY_THR_STATIC },	/* 517 = cap_getmode */
	...
	{ AS(__sysctlbyname_args), (sy_call_t *)sys___sysctlbyname, AUE_SYSCTL, NULL, 0, 0, SYF_PLEDGE_ALWAYS | SYF_CAPENABLED, SY_THR_STATIC },	/* 570 = __sysctlbyname */
