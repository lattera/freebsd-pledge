...
struct sysent sysent[] = {
	...
	{ AS(sys_exit_args), (sy_call_t *)sys_sys_exit, AUE_EXIT, NULL, 0, 0, SYF_PLEDGE_ALWAYS | SYF_CAPENABLED, SY_THR_STATIC },	/* 1 = exit */
	{ 0, (sy_call_t *)sys_fork, AUE_FORK, NULL, 0, 0, SYF_PLEDGE_PROC | SYF_CAPENABLED, SY_THR_STATIC },	/* 2 = fork */
	{ AS(read_args), (sy_call_t *)sys_read, AUE_READ, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 3 = read */
	{ AS(write_args), (sy_call_t *)sys_write, AUE_WRITE, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 4 = write */
	{ AS(open_args), (sy_call_t *)sys_open, AUE_OPEN_RWTC, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_PLEDGE_RPATH | SYF_PLEDGE_WPATH, SY_THR_STATIC },	/* 5 = open */
	{ AS(close_args), (sy_call_t *)sys_close, AUE_CLOSE, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 6 = close */
	{ AS(wait4_args), (sy_call_t *)sys_wait4, AUE_WAIT4, NULL, 0, 0, SYF_PLEDGE_STDIO, SY_THR_STATIC },	/* 7 = wait4 */
	{ compat(AS(ocreat_args),creat), AUE_CREAT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 8 = old creat */
	{ AS(link_args), (sy_call_t *)sys_link, AUE_LINK, NULL, 0, 0, SYF_PLEDGE_CPATH, SY_THR_STATIC },	/* 9 = link */
	{ AS(unlink_args), (sy_call_t *)sys_unlink, AUE_UNLINK, NULL, 0, 0, SYF_PLEDGE_CPATH, SY_THR_STATIC },	/* 10 = unlink */
	{ 0, (sy_call_t *)nosys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },			/* 11 = obsolete execv */
	{ AS(chdir_args), (sy_call_t *)sys_chdir, AUE_CHDIR, NULL, 0, 0, SYF_PLEDGE_RPATH, SY_THR_STATIC },	/* 12 = chdir */
	{ AS(fchdir_args), (sy_call_t *)sys_fchdir, AUE_FCHDIR, NULL, 0, 0, SYF_PLEDGE_STDIO, SY_THR_STATIC },	/* 13 = fchdir */
	{ compat11(AS(freebsd11_mknod_args),mknod), AUE_MKNOD, NULL, 0, 0, 0, SY_THR_STATIC },	/* 14 = freebsd11 mknod */
	{ AS(chmod_args), (sy_call_t *)sys_chmod, AUE_CHMOD, NULL, 0, 0, SYF_PLEDGE_FATTR, SY_THR_STATIC },	/* 15 = chmod */
	{ AS(chown_args), (sy_call_t *)sys_chown, AUE_CHOWN, NULL, 0, 0, SYF_PLEDGE_CHOWN, SY_THR_STATIC },	/* 16 = chown */
	{ AS(break_args), (sy_call_t *)sys_break, AUE_NULL, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 17 = break */
	...
	{ 0, (sy_call_t *)sys_getpid, AUE_GETPID, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 20 = getpid */
	...
	{ AS(setuid_args), (sy_call_t *)sys_setuid, AUE_SETUID, NULL, 0, 0, SYF_PLEDGE_ID | SYF_CAPENABLED, SY_THR_STATIC },	/* 23 = setuid */
	{ 0, (sy_call_t *)sys_getuid, AUE_GETUID, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 24 = getuid */
	{ 0, (sy_call_t *)sys_geteuid, AUE_GETEUID, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 25 = geteuid */
	{ AS(ptrace_args), (sy_call_t *)sys_ptrace, AUE_PTRACE, NULL, 0, 0, 0, SY_THR_STATIC },	/* 26 = ptrace */
	{ AS(recvmsg_args), (sy_call_t *)sys_recvmsg, AUE_RECVMSG, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 27 = recvmsg */
	{ AS(sendmsg_args), (sy_call_t *)sys_sendmsg, AUE_SENDMSG, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 28 = sendmsg */
	{ AS(recvfrom_args), (sy_call_t *)sys_recvfrom, AUE_RECVFROM, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_PLEDGE_YPACTIVE | SYF_CAPENABLED, SY_THR_STATIC },	/* 29 = recvfrom */
	{ AS(accept_args), (sy_call_t *)sys_accept, AUE_ACCEPT, NULL, 0, 0, SYF_PLEDGE_INET | SYF_PLEDGE_UNIX | SYF_CAPENABLED, SY_THR_STATIC },	/* 30 = accept */
	{ AS(getpeername_args), (sy_call_t *)sys_getpeername, AUE_GETPEERNAME, NULL, 0, 0, SYF_PLEDGE_INET | SYF_PLEDGE_UNIX | SYF_CAPENABLED, SY_THR_STATIC },	/* 31 = getpeername */
	{ AS(getsockname_args), (sy_call_t *)sys_getsockname, AUE_GETSOCKNAME, NULL, 0, 0, SYF_PLEDGE_INET | SYF_PLEDGE_UNIX | SYF_PLEDGE_DNS | SYF_PLEDGE_YPACTIVE | SYF_CAPENABLED, SY_THR_STATIC },	/* 32 = getsockname */
	{ AS(access_args), (sy_call_t *)sys_access, AUE_ACCESS, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_PLEDGE_RPATH | SYF_PLEDGE_WPATH, SY_THR_STATIC },	/* 33 = access */
	{ AS(chflags_args), (sy_call_t *)sys_chflags, AUE_CHFLAGS, NULL, 0, 0, SYF_PLEDGE_FATTR, SY_THR_STATIC },	/* 34 = chflags */
	{ AS(fchflags_args), (sy_call_t *)sys_fchflags, AUE_FCHFLAGS, NULL, 0, 0, SYF_PLEDGE_FATTR | SYF_CAPENABLED, SY_THR_STATIC },	/* 35 = fchflags */
	{ 0, (sy_call_t *)sys_sync, AUE_SYNC, NULL, 0, 0, SYF_CAPENABLED, SY_THR_STATIC },	/* 36 = sync */
	{ AS(kill_args), (sy_call_t *)sys_kill, AUE_KILL, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 37 = kill */
	{ compat(AS(ostat_args),stat), AUE_STAT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 38 = old stat */
	{ 0, (sy_call_t *)sys_getppid, AUE_GETPPID, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 39 = getppid */
	{ compat(AS(olstat_args),lstat), AUE_LSTAT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 40 = old lstat */
	{ AS(dup_args), (sy_call_t *)sys_dup, AUE_DUP, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 41 = dup */
	{ compat10(0,pipe), AUE_PIPE, NULL, 0, 0, SYF_CAPENABLED, SY_THR_STATIC },	/* 42 = freebsd10 pipe */
	{ 0, (sy_call_t *)sys_getegid, AUE_GETEGID, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 43 = getegid */
	...
	{ 0, (sy_call_t *)sys_getgid, AUE_GETGID, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 47 = getgid */
	{ compat(AS(osigprocmask_args),sigprocmask), AUE_SIGPROCMASK, NULL, 0, 0, SYF_CAPENABLED, SY_THR_STATIC },	/* 48 = old sigprocmask */
	{ AS(getlogin_args), (sy_call_t *)sys_getlogin, AUE_GETLOGIN, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 49 = getlogin */
	{ AS(setlogin_args), (sy_call_t *)sys_setlogin, AUE_SETLOGIN, NULL, 0, 0, SYF_PLEDGE_ID, SY_THR_STATIC },	/* 50 = setlogin */
	...
	{ AS(sigaltstack_args), (sy_call_t *)sys_sigaltstack, AUE_SIGALTSTACK, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 53 = sigaltstack */
	{ AS(ioctl_args), (sy_call_t *)sys_ioctl, AUE_IOCTL, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 54 = ioctl */
	{ AS(reboot_args), (sy_call_t *)sys_reboot, AUE_REBOOT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 55 = reboot */
	{ AS(revoke_args), (sy_call_t *)sys_revoke, AUE_REVOKE, NULL, 0, 0, SYF_PLEDGE_TTY, SY_THR_STATIC },	/* 56 = revoke */
	{ AS(symlink_args), (sy_call_t *)sys_symlink, AUE_SYMLINK, NULL, 0, 0, SYF_PLEDGE_CPATH, SY_THR_STATIC },	/* 57 = symlink */
	{ AS(readlink_args), (sy_call_t *)sys_readlink, AUE_READLINK, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_PLEDGE_RPATH | SYF_PLEDGE_WPATH, SY_THR_STATIC },	/* 58 = readlink */
	{ AS(execve_args), (sy_call_t *)sys_execve, AUE_EXECVE, NULL, 0, 0, SYF_PLEDGE_EXEC, SY_THR_STATIC },	/* 59 = execve */
	{ AS(umask_args), (sy_call_t *)sys_umask, AUE_UMASK, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 60 = umask */
	...
	{ AS(msync_args), (sy_call_t *)sys_msync, AUE_MSYNC, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 65 = msync */
	{ 0, (sy_call_t *)sys_vfork, AUE_VFORK, NULL, 0, 0, SYF_PLEDGE_PROC, SY_THR_STATIC },	/* 66 = vfork */
	...
	{ AS(munmap_args), (sy_call_t *)sys_munmap, AUE_MUNMAP, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 73 = munmap */
	{ AS(mprotect_args), (sy_call_t *)sys_mprotect, AUE_MPROTECT, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 74 = mprotect */
	{ AS(madvise_args), (sy_call_t *)sys_madvise, AUE_MADVISE, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 75 = madvise */
	...
	{ AS(mincore_args), (sy_call_t *)sys_mincore, AUE_MINCORE, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 78 = mincore */
	{ AS(getgroups_args), (sy_call_t *)sys_getgroups, AUE_GETGROUPS, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 79 = getgroups */
	{ AS(setgroups_args), (sy_call_t *)sys_setgroups, AUE_SETGROUPS, NULL, 0, 0, SYF_PLEDGE_ID, SY_THR_STATIC },	/* 80 = setgroups */
	{ 0, (sy_call_t *)sys_getpgrp, AUE_GETPGRP, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 81 = getpgrp */
	{ AS(setpgid_args), (sy_call_t *)sys_setpgid, AUE_SETPGRP, NULL, 0, 0, SYF_PLEDGE_PROC, SY_THR_STATIC },	/* 82 = setpgid */
	{ AS(setitimer_args), (sy_call_t *)sys_setitimer, AUE_SETITIMER, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 83 = setitimer */
	...
	{ AS(getitimer_args), (sy_call_t *)sys_getitimer, AUE_GETITIMER, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 86 = getitimer */
	...
	{ 0, (sy_call_t *)sys_getdtablesize, AUE_GETDTABLESIZE, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 89 = getdtablesize */
	{ AS(dup2_args), (sy_call_t *)sys_dup2, AUE_DUP2, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 90 = dup2 */
	{ 0, (sy_call_t *)nosys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },			/* 91 = getdopt */
	{ AS(fcntl_args), (sy_call_t *)sys_fcntl, AUE_FCNTL, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 92 = fcntl */
	{ AS(select_args), (sy_call_t *)sys_select, AUE_SELECT, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 93 = select */
	{ 0, (sy_call_t *)nosys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },			/* 94 = setdopt */
	{ AS(fsync_args), (sy_call_t *)sys_fsync, AUE_FSYNC, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 95 = fsync */
	{ AS(setpriority_args), (sy_call_t *)sys_setpriority, AUE_SETPRIORITY, NULL, 0, 0, SYF_PLEDGE_PROC | SYF_PLEDGE_ID | SYF_CAPENABLED, SY_THR_STATIC },	/* 96 = setpriority */
	{ AS(socket_args), (sy_call_t *)sys_socket, AUE_SOCKET, NULL, 0, 0, SYF_PLEDGE_INET | SYF_PLEDGE_UNIX | SYF_PLEDGE_DNS | SYF_PLEDGE_YPACTIVE | SYF_CAPENABLED, SY_THR_STATIC },	/* 97 = socket */
	{ AS(connect_args), (sy_call_t *)sys_connect, AUE_CONNECT, NULL, 0, 0, SYF_PLEDGE_INET | SYF_PLEDGE_UNIX | SYF_PLEDGE_DNS | SYF_PLEDGE_YPACTIVE, SY_THR_STATIC },	/* 98 = connect */
	{ compat(AS(oaccept_args),accept), AUE_ACCEPT, NULL, 0, 0, SYF_CAPENABLED, SY_THR_STATIC },	/* 99 = old accept */
	{ AS(getpriority_args), (sy_call_t *)sys_getpriority, AUE_GETPRIORITY, NULL, 0, 0, SYF_PLEDGE_PROC | SYF_PLEDGE_ID | SYF_CAPENABLED, SY_THR_STATIC },	/* 100 = getpriority */
	...
	{ AS(bind_args), (sy_call_t *)sys_bind, AUE_BIND, NULL, 0, 0, SYF_PLEDGE_INET | SYF_PLEDGE_UNIX | SYF_PLEDGE_DNS | SYF_PLEDGE_YPACTIVE, SY_THR_STATIC },	/* 104 = bind */
	{ AS(setsockopt_args), (sy_call_t *)sys_setsockopt, AUE_SETSOCKOPT, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 105 = setsockopt */
	{ AS(listen_args), (sy_call_t *)sys_listen, AUE_LISTEN, NULL, 0, 0, SYF_PLEDGE_INET | SYF_PLEDGE_UNIX | SYF_CAPENABLED, SY_THR_STATIC },	/* 106 = listen */
	...
	{ AS(gettimeofday_args), (sy_call_t *)sys_gettimeofday, AUE_GETTIMEOFDAY, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 116 = gettimeofday */
	{ AS(getrusage_args), (sy_call_t *)sys_getrusage, AUE_GETRUSAGE, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 117 = getrusage */
	{ AS(getsockopt_args), (sy_call_t *)sys_getsockopt, AUE_GETSOCKOPT, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 118 = getsockopt */
	{ 0, (sy_call_t *)nosys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },			/* 119 = resuba */
	{ AS(readv_args), (sy_call_t *)sys_readv, AUE_READV, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 120 = readv */
	{ AS(writev_args), (sy_call_t *)sys_writev, AUE_WRITEV, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 121 = writev */
	{ AS(settimeofday_args), (sy_call_t *)sys_settimeofday, AUE_SETTIMEOFDAY, NULL, 0, 0, SYF_PLEDGE_SETTIME, SY_THR_STATIC },	/* 122 = settimeofday */
	{ AS(fchown_args), (sy_call_t *)sys_fchown, AUE_FCHOWN, NULL, 0, 0, SYF_PLEDGE_CHOWN | SYF_CAPENABLED, SY_THR_STATIC },	/* 123 = fchown */
	{ AS(fchmod_args), (sy_call_t *)sys_fchmod, AUE_FCHMOD, NULL, 0, 0, SYF_PLEDGE_FATTR | SYF_CAPENABLED, SY_THR_STATIC },	/* 124 = fchmod */
	{ compat(AS(recvfrom_args),recvfrom), AUE_RECVFROM, NULL, 0, 0, SYF_CAPENABLED, SY_THR_STATIC },	/* 125 = old recvfrom */
	{ AS(setreuid_args), (sy_call_t *)sys_setreuid, AUE_SETREUID, NULL, 0, 0, SYF_PLEDGE_ID | SYF_CAPENABLED, SY_THR_STATIC },	/* 126 = setreuid */
	{ AS(setregid_args), (sy_call_t *)sys_setregid, AUE_SETREGID, NULL, 0, 0, SYF_PLEDGE_ID | SYF_CAPENABLED, SY_THR_STATIC },	/* 127 = setregid */
	{ AS(rename_args), (sy_call_t *)sys_rename, AUE_RENAME, NULL, 0, 0, SYF_PLEDGE_RPATH | SYF_PLEDGE_CPATH, SY_THR_STATIC },	/* 128 = rename */
	...
	{ AS(flock_args), (sy_call_t *)sys_flock, AUE_FLOCK, NULL, 0, 0, SYF_PLEDGE_FLOCK | SYF_PLEDGE_YPACTIVE | SYF_CAPENABLED, SY_THR_STATIC },	/* 131 = flock */
	{ AS(mkfifo_args), (sy_call_t *)sys_mkfifo, AUE_MKFIFO, NULL, 0, 0, SYF_PLEDGE_DPATH, SY_THR_STATIC },	/* 132 = mkfifo */
	{ AS(sendto_args), (sy_call_t *)sys_sendto, AUE_SENDTO, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_PLEDGE_YPACTIVE | SYF_CAPENABLED, SY_THR_STATIC },	/* 133 = sendto */
	{ AS(shutdown_args), (sy_call_t *)sys_shutdown, AUE_SHUTDOWN, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 134 = shutdown */
	{ AS(socketpair_args), (sy_call_t *)sys_socketpair, AUE_SOCKETPAIR, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 135 = socketpair */
	{ AS(mkdir_args), (sy_call_t *)sys_mkdir, AUE_MKDIR, NULL, 0, 0, SYF_PLEDGE_CPATH, SY_THR_STATIC },	/* 136 = mkdir */
	{ AS(rmdir_args), (sy_call_t *)sys_rmdir, AUE_RMDIR, NULL, 0, 0, SYF_PLEDGE_CPATH, SY_THR_STATIC },	/* 137 = rmdir */
	{ AS(utimes_args), (sy_call_t *)sys_utimes, AUE_UTIMES, NULL, 0, 0, SYF_PLEDGE_FATTR, SY_THR_STATIC },	/* 138 = utimes */
	{ 0, (sy_call_t *)nosys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },			/* 139 = obsolete 4.2 sigreturn */
	{ AS(adjtime_args), (sy_call_t *)sys_adjtime, AUE_ADJTIME, NULL, 0, 0, SYF_PLEDGE_STDIO, SY_THR_STATIC },	/* 140 = adjtime */
	...
	{ 0, (sy_call_t *)sys_setsid, AUE_SETSID, NULL, 0, 0, SYF_PLEDGE_PROC | SYF_CAPENABLED, SY_THR_STATIC },	/* 147 = setsid */
	...
	{ AS(sysarch_args), (sy_call_t *)sysarch, AUE_SYSARCH, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 165 = sysarch */
	{ AS(rtprio_args), (sy_call_t *)sys_rtprio, AUE_RTPRIO, NULL, 0, 0, SYF_PLEDGE_PROC | SYF_CAPENABLED, SY_THR_STATIC },	/* 166 = rtprio */
	...
	{ AS(ntp_adjtime_args), (sy_call_t *)sys_ntp_adjtime, AUE_NTP_ADJTIME, NULL, 0, 0, SYF_PLEDGE_SETTIME, SY_THR_STATIC },	/* 176 = ntp_adjtime */
	...
	{ AS(setgid_args), (sy_call_t *)sys_setgid, AUE_SETGID, NULL, 0, 0, SYF_PLEDGE_ID | SYF_CAPENABLED, SY_THR_STATIC },	/* 181 = setgid */
	{ AS(setegid_args), (sy_call_t *)sys_setegid, AUE_SETEGID, NULL, 0, 0, SYF_PLEDGE_ID | SYF_CAPENABLED, SY_THR_STATIC },	/* 182 = setegid */
	{ AS(seteuid_args), (sy_call_t *)sys_seteuid, AUE_SETEUID, NULL, 0, 0, SYF_PLEDGE_ID | SYF_CAPENABLED, SY_THR_STATIC },	/* 183 = seteuid */
	...
	{ AS(pathconf_args), (sy_call_t *)sys_pathconf, AUE_PATHCONF, NULL, 0, 0, SYF_PLEDGE_RPATH, SY_THR_STATIC },	/* 191 = pathconf */
	{ AS(fpathconf_args), (sy_call_t *)sys_fpathconf, AUE_FPATHCONF, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 192 = fpathconf */
	{ 0, (sy_call_t *)nosys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },			/* 193 = nosys */
	{ AS(__getrlimit_args), (sy_call_t *)sys_getrlimit, AUE_GETRLIMIT, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 194 = getrlimit */
	{ AS(__setrlimit_args), (sy_call_t *)sys_setrlimit, AUE_SETRLIMIT, NULL, 0, 0, SYF_PLEDGE_PROC | SYF_PLEDGE_ID | SYF_CAPENABLED, SY_THR_STATIC },	/* 195 = setrlimit */
	...
	{ AS(sysctl_args), (sy_call_t *)sys___sysctl, AUE_SYSCTL, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 202 = __sysctl */
	...
	{ AS(futimes_args), (sy_call_t *)sys_futimes, AUE_FUTIMES, NULL, 0, 0, SYF_PLEDGE_FATTR | SYF_CAPENABLED, SY_THR_STATIC },	/* 206 = futimes */
	{ AS(getpgid_args), (sy_call_t *)sys_getpgid, AUE_GETPGID, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 207 = getpgid */
	{ 0, (sy_call_t *)nosys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },			/* 208 = nosys */
	{ AS(poll_args), (sy_call_t *)sys_poll, AUE_POLL, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 209 = poll */
	...
	{ AS(clock_gettime_args), (sy_call_t *)sys_clock_gettime, AUE_NULL, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 232 = clock_gettime */
	{ AS(clock_settime_args), (sy_call_t *)sys_clock_settime, AUE_CLOCK_SETTIME, NULL, 0, 0, SYF_PLEDGE_SETTIME, SY_THR_STATIC },	/* 233 = clock_settime */
	{ AS(clock_getres_args), (sy_call_t *)sys_clock_getres, AUE_NULL, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 234 = clock_getres */
	...
	{ AS(nanosleep_args), (sy_call_t *)sys_nanosleep, AUE_NULL, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 240 = nanosleep */
	...
	{ AS(ntp_gettime_args), (sy_call_t *)sys_ntp_gettime, AUE_NULL, NULL, 0, 0, SYF_PLEDGE_SETTIME | SYF_CAPENABLED, SY_THR_STATIC },	/* 248 = ntp_gettime */
	{ 0, (sy_call_t *)nosys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },			/* 249 = nosys */
	{ AS(minherit_args), (sy_call_t *)sys_minherit, AUE_MINHERIT, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 250 = minherit */
	{ AS(rfork_args), (sy_call_t *)sys_rfork, AUE_RFORK, NULL, 0, 0, SYF_PLEDGE_PROC, SY_THR_STATIC },	/* 251 = rfork */
	{ 0, (sy_call_t *)nosys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },			/* 252 = obsolete openbsd_poll */
	{ 0, (sy_call_t *)sys_issetugid, AUE_ISSETUGID, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 253 = issetugid */
	{ AS(lchown_args), (sy_call_t *)sys_lchown, AUE_LCHOWN, NULL, 0, 0, SYF_PLEDGE_CHOWN, SY_THR_STATIC },	/* 254 = lchown */
	...
	{ AS(lchmod_args), (sy_call_t *)sys_lchmod, AUE_LCHMOD, NULL, 0, 0, SYF_PLEDGE_FATTR, SY_THR_STATIC },	/* 274 = lchmod */
	{ 0, (sy_call_t *)nosys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },			/* 275 = obsolete netbsd_lchown */
	{ AS(lutimes_args), (sy_call_t *)sys_lutimes, AUE_LUTIMES, NULL, 0, 0, SYF_PLEDGE_FATTR, SY_THR_STATIC },	/* 276 = lutimes */
	...
	{ AS(preadv_args), (sy_call_t *)sys_preadv, AUE_PREADV, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 289 = preadv */
	{ AS(pwritev_args), (sy_call_t *)sys_pwritev, AUE_PWRITEV, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 290 = pwritev */
	...
	{ AS(getsid_args), (sy_call_t *)sys_getsid, AUE_GETSID, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 310 = getsid */
	{ AS(setresuid_args), (sy_call_t *)sys_setresuid, AUE_SETRESUID, NULL, 0, 0, SYF_PLEDGE_ID | SYF_CAPENABLED, SY_THR_STATIC },	/* 311 = setresuid */
	{ AS(setresgid_args), (sy_call_t *)sys_setresgid, AUE_SETRESGID, NULL, 0, 0, SYF_PLEDGE_ID | SYF_CAPENABLED, SY_THR_STATIC },	/* 312 = setresgid */
	...
	{ 0, (sy_call_t *)sys_yield, AUE_NULL, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 321 = yield */
	...
	{ AS(__getcwd_args), (sy_call_t *)sys___getcwd, AUE_GETCWD, NULL, 0, 0, SYF_PLEDGE_RPATH | SYF_PLEDGE_WPATH, SY_THR_STATIC },	/* 326 = __getcwd */
	...
	{ 0, (sy_call_t *)sys_sched_yield, AUE_NULL, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 331 = sched_yield */
	...
	{ AS(utrace_args), (sy_call_t *)sys_utrace, AUE_NULL, NULL, 0, 0, SYF_PLEDGE_ALWAYS | SYF_CAPENABLED, SY_THR_STATIC },	/* 335 = utrace */
	...
	{ AS(sigprocmask_args), (sy_call_t *)sys_sigprocmask, AUE_SIGPROCMASK, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 340 = sigprocmask */
	{ AS(sigsuspend_args), (sy_call_t *)sys_sigsuspend, AUE_SIGSUSPEND, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 341 = sigsuspend */
	{ compat4(AS(freebsd4_sigaction_args),sigaction), AUE_SIGACTION, NULL, 0, 0, SYF_CAPENABLED, SY_THR_STATIC },	/* 342 = freebsd4 sigaction */
	{ AS(sigpending_args), (sy_call_t *)sys_sigpending, AUE_SIGPENDING, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 343 = sigpending */
	{ compat4(AS(freebsd4_sigreturn_args),sigreturn), AUE_SIGRETURN, NULL, 0, 0, SYF_CAPENABLED, SY_THR_STATIC },	/* 344 = freebsd4 sigreturn */
	{ AS(sigtimedwait_args), (sy_call_t *)sys_sigtimedwait, AUE_SIGWAIT, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 345 = sigtimedwait */
	{ AS(sigwaitinfo_args), (sy_call_t *)sys_sigwaitinfo, AUE_NULL, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 346 = sigwaitinfo */
	...
	{ AS(getresuid_args), (sy_call_t *)sys_getresuid, AUE_GETRESUID, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 360 = getresuid */
	{ AS(getresgid_args), (sy_call_t *)sys_getresgid, AUE_GETRESGID, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 361 = getresgid */
	{ 0, (sy_call_t *)sys_kqueue, AUE_KQUEUE, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 362 = kqueue */
	...
	{ AS(__setugid_args), (sy_call_t *)sys___setugid, AUE_SETUGID, NULL, 0, 0, SYF_PLEDGE_ID, SY_THR_STATIC },	/* 374 = __setugid */
	{ 0, (sy_call_t *)nosys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },			/* 375 = obsolete nfsclnt */
	{ AS(eaccess_args), (sy_call_t *)sys_eaccess, AUE_EACCESS, NULL, 0, 0, SYF_PLEDGE_STDIO, SY_THR_STATIC },	/* 376 = eaccess */
	...
	{ AS(lchflags_args), (sy_call_t *)sys_lchflags, AUE_LCHFLAGS, NULL, 0, 0, SYF_PLEDGE_FATTR, SY_THR_STATIC },	/* 391 = lchflags */
	{ AS(uuidgen_args), (sy_call_t *)sys_uuidgen, AUE_NULL, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 392 = uuidgen */
	{ AS(sendfile_args), (sy_call_t *)sys_sendfile, AUE_SENDFILE, NULL, 0, 0, SYF_PLEDGE_INET | SYF_PLEDGE_UNIX | SYF_CAPENABLED, SY_THR_STATIC },	/* 393 = sendfile */
	...
	{ AS(sigaction_args), (sy_call_t *)sys_sigaction, AUE_SIGACTION, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 416 = sigaction */
	{ AS(sigreturn_args), (sy_call_t *)sys_sigreturn, AUE_SIGRETURN, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 417 = sigreturn */
	...
	{ AS(getcontext_args), (sy_call_t *)sys_getcontext, AUE_NULL, NULL, 0, 0, SYF_PLEDGE_THREAD | SYF_CAPENABLED, SY_THR_STATIC },	/* 421 = getcontext */
	{ AS(setcontext_args), (sy_call_t *)sys_setcontext, AUE_NULL, NULL, 0, 0, SYF_PLEDGE_THREAD | SYF_CAPENABLED, SY_THR_STATIC },	/* 422 = setcontext */
	{ AS(swapcontext_args), (sy_call_t *)sys_swapcontext, AUE_NULL, NULL, 0, 0, SYF_PLEDGE_THREAD, SY_THR_STATIC },	/* 423 = swapcontext */
	...
	{ AS(sigwait_args), (sy_call_t *)sys_sigwait, AUE_SIGWAIT, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 429 = sigwait */
	{ AS(thr_create_args), (sy_call_t *)sys_thr_create, AUE_THR_CREATE, NULL, 0, 0, SYF_PLEDGE_THREAD | SYF_CAPENABLED, SY_THR_STATIC },	/* 430 = thr_create */
	{ AS(thr_exit_args), (sy_call_t *)sys_thr_exit, AUE_THR_EXIT, NULL, 0, 0, SYF_PLEDGE_THREAD | SYF_CAPENABLED, SY_THR_STATIC },	/* 431 = thr_exit */
	{ AS(thr_self_args), (sy_call_t *)sys_thr_self, AUE_NULL, NULL, 0, 0, SYF_PLEDGE_ALWAYS | SYF_CAPENABLED, SY_THR_STATIC },	/* 432 = thr_self */
	{ AS(thr_kill_args), (sy_call_t *)sys_thr_kill, AUE_THR_KILL, NULL, 0, 0, SYF_PLEDGE_ALWAYS | SYF_CAPENABLED, SY_THR_STATIC },	/* 433 = thr_kill */
	...
	{ AS(thr_suspend_args), (sy_call_t *)sys_thr_suspend, AUE_NULL, NULL, 0, 0, SYF_PLEDGE_THREAD | SYF_CAPENABLED, SY_THR_STATIC },	/* 442 = thr_suspend */
	{ AS(thr_wake_args), (sy_call_t *)sys_thr_wake, AUE_NULL, NULL, 0, 0, SYF_PLEDGE_THREAD | SYF_CAPENABLED, SY_THR_STATIC },	/* 443 = thr_wake */
	...
	{ AS(_umtx_op_args), (sy_call_t *)sys__umtx_op, AUE_NULL, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 454 = _umtx_op */
	{ AS(thr_new_args), (sy_call_t *)sys_thr_new, AUE_THR_NEW, NULL, 0, 0, SYF_PLEDGE_THREAD | SYF_CAPENABLED, SY_THR_STATIC },	/* 455 = thr_new */
	{ AS(sigqueue_args), (sy_call_t *)sys_sigqueue, AUE_NULL, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 456 = sigqueue */
	...
	{ AS(abort2_args), (sy_call_t *)sys_abort2, AUE_NULL, NULL, 0, 0, SYF_PLEDGE_ALWAYS | SYF_CAPENABLED, SY_THR_STATIC },	/* 463 = abort2 */
	{ AS(thr_set_name_args), (sy_call_t *)sys_thr_set_name, AUE_NULL, NULL, 0, 0, SYF_PLEDGE_THREAD | SYF_CAPENABLED, SY_THR_STATIC },	/* 464 = thr_set_name */
	{ AS(aio_fsync_args), (sy_call_t *)sys_aio_fsync, AUE_AIO_FSYNC, NULL, 0, 0, SYF_CAPENABLED, SY_THR_STATIC },	/* 465 = aio_fsync */
	{ AS(rtprio_thread_args), (sy_call_t *)sys_rtprio_thread, AUE_RTPRIO, NULL, 0, 0, SYF_PLEDGE_THREAD | SYF_CAPENABLED, SY_THR_STATIC },	/* 466 = rtprio_thread */
	...
	{ AS(pread_args), (sy_call_t *)sys_pread, AUE_PREAD, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 475 = pread */
	{ AS(pwrite_args), (sy_call_t *)sys_pwrite, AUE_PWRITE, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 476 = pwrite */
	{ AS(mmap_args), (sy_call_t *)sys_mmap, AUE_MMAP, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 477 = mmap */
	{ AS(lseek_args), (sy_call_t *)sys_lseek, AUE_LSEEK, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 478 = lseek */
	{ AS(truncate_args), (sy_call_t *)sys_truncate, AUE_TRUNCATE, NULL, 0, 0, SYF_PLEDGE_WPATH, SY_THR_STATIC },	/* 479 = truncate */
	{ AS(ftruncate_args), (sy_call_t *)sys_ftruncate, AUE_FTRUNCATE, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 480 = ftruncate */
	{ AS(thr_kill2_args), (sy_call_t *)sys_thr_kill2, AUE_THR_KILL2, NULL, 0, 0, SYF_PLEDGE_THREAD, SY_THR_STATIC },	/* 481 = thr_kill2 */
	...
	{ AS(faccessat_args), (sy_call_t *)sys_faccessat, AUE_FACCESSAT, NULL, 0, 0, SYF_PLEDGE_RPATH | SYF_PLEDGE_WPATH | SYF_CAPENABLED, SY_THR_STATIC },	/* 489 = faccessat */
	{ AS(fchmodat_args), (sy_call_t *)sys_fchmodat, AUE_FCHMODAT, NULL, 0, 0, SYF_PLEDGE_FATTR | SYF_CAPENABLED, SY_THR_STATIC },	/* 490 = fchmodat */
	{ AS(fchownat_args), (sy_call_t *)sys_fchownat, AUE_FCHOWNAT, NULL, 0, 0, SYF_PLEDGE_CHOWN | SYF_CAPENABLED, SY_THR_STATIC },	/* 491 = fchownat */
	{ AS(fexecve_args), (sy_call_t *)sys_fexecve, AUE_FEXECVE, NULL, 0, 0, SYF_PLEDGE_EXEC | SYF_CAPENABLED, SY_THR_STATIC },	/* 492 = fexecve */
	{ compat11(AS(freebsd11_fstatat_args),fstatat), AUE_FSTATAT, NULL, 0, 0, SYF_CAPENABLED, SY_THR_STATIC },	/* 493 = freebsd11 fstatat */
	{ AS(futimesat_args), (sy_call_t *)sys_futimesat, AUE_FUTIMESAT, NULL, 0, 0, SYF_PLEDGE_FATTR | SYF_CAPENABLED, SY_THR_STATIC },	/* 494 = futimesat */
	{ AS(linkat_args), (sy_call_t *)sys_linkat, AUE_LINKAT, NULL, 0, 0, SYF_PLEDGE_CPATH | SYF_CAPENABLED, SY_THR_STATIC },	/* 495 = linkat */
	{ AS(mkdirat_args), (sy_call_t *)sys_mkdirat, AUE_MKDIRAT, NULL, 0, 0, SYF_PLEDGE_CPATH | SYF_CAPENABLED, SY_THR_STATIC },	/* 496 = mkdirat */
	{ AS(mkfifoat_args), (sy_call_t *)sys_mkfifoat, AUE_MKFIFOAT, NULL, 0, 0, SYF_PLEDGE_DPATH | SYF_CAPENABLED, SY_THR_STATIC },	/* 497 = mkfifoat */
	{ compat11(AS(freebsd11_mknodat_args),mknodat), AUE_MKNODAT, NULL, 0, 0, SYF_CAPENABLED, SY_THR_STATIC },	/* 498 = freebsd11 mknodat */
	{ AS(openat_args), (sy_call_t *)sys_openat, AUE_OPENAT_RWTC, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_PLEDGE_RPATH | SYF_PLEDGE_WPATH | SYF_CAPENABLED, SY_THR_STATIC },	/* 499 = openat */
	{ AS(readlinkat_args), (sy_call_t *)sys_readlinkat, AUE_READLINKAT, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_PLEDGE_RPATH | SYF_PLEDGE_WPATH | SYF_CAPENABLED, SY_THR_STATIC },	/* 500 = readlinkat */
	{ AS(renameat_args), (sy_call_t *)sys_renameat, AUE_RENAMEAT, NULL, 0, 0, SYF_PLEDGE_CPATH | SYF_CAPENABLED, SY_THR_STATIC },	/* 501 = renameat */
	{ AS(symlinkat_args), (sy_call_t *)sys_symlinkat, AUE_SYMLINKAT, NULL, 0, 0, SYF_PLEDGE_CPATH | SYF_CAPENABLED, SY_THR_STATIC },	/* 502 = symlinkat */
	{ AS(unlinkat_args), (sy_call_t *)sys_unlinkat, AUE_UNLINKAT, NULL, 0, 0, SYF_PLEDGE_CPATH | SYF_CAPENABLED, SY_THR_STATIC },	/* 503 = unlinkat */
	{ AS(posix_openpt_args), (sy_call_t *)sys_posix_openpt, AUE_POSIX_OPENPT, NULL, 0, 0, SYF_PLEDGE_TTY, SY_THR_STATIC },	/* 504 = posix_openpt */
	...
	{ compat12(AS(freebsd12_closefrom_args),closefrom), AUE_CLOSEFROM, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 509 = freebsd12 closefrom */
	...
	{ AS(lpathconf_args), (sy_call_t *)sys_lpathconf, AUE_LPATHCONF, NULL, 0, 0, SYF_PLEDGE_RPATH, SY_THR_STATIC },	/* 513 = lpathconf */
	{ 0, (sy_call_t *)nosys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },			/* 514 = obsolete cap_new */
	{ AS(__cap_rights_get_args), (sy_call_t *)sys___cap_rights_get, AUE_CAP_RIGHTS_GET, NULL, 0, 0, SYF_PLEDGE_CAPCOMPAT | SYF_CAPENABLED, SY_THR_STATIC },	/* 515 = __cap_rights_get */
	{ 0, (sy_call_t *)sys_cap_enter, AUE_CAP_ENTER, NULL, 0, 0, SYF_PLEDGE_ALWAYS | SYF_CAPENABLED, SY_THR_STATIC },	/* 516 = cap_enter */
	{ AS(cap_getmode_args), (sy_call_t *)sys_cap_getmode, AUE_CAP_GETMODE, NULL, 0, 0, SYF_PLEDGE_CAPCOMPAT | SYF_CAPENABLED, SY_THR_STATIC },	/* 517 = cap_getmode */
	{ AS(pdfork_args), (sy_call_t *)sys_pdfork, AUE_PDFORK, NULL, 0, 0, SYF_PLEDGE_PROC | SYF_CAPENABLED, SY_THR_STATIC },	/* 518 = pdfork */
	{ AS(pdkill_args), (sy_call_t *)sys_pdkill, AUE_PDKILL, NULL, 0, 0, SYF_PLEDGE_PROC | SYF_CAPENABLED, SY_THR_STATIC },	/* 519 = pdkill */
	{ AS(pdgetpid_args), (sy_call_t *)sys_pdgetpid, AUE_PDGETPID, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 520 = pdgetpid */
	{ 0, (sy_call_t *)nosys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },			/* 521 = pdwait4 */
	{ AS(pselect_args), (sy_call_t *)sys_pselect, AUE_SELECT, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 522 = pselect */
	{ AS(getloginclass_args), (sy_call_t *)sys_getloginclass, AUE_GETLOGINCLASS, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 523 = getloginclass */
	{ AS(setloginclass_args), (sy_call_t *)sys_setloginclass, AUE_SETLOGINCLASS, NULL, 0, 0, SYF_PLEDGE_ID, SY_THR_STATIC },	/* 524 = setloginclass */
	...
	{ AS(posix_fallocate_args), (sy_call_t *)sys_posix_fallocate, AUE_POSIX_FALLOCATE, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 530 = posix_fallocate */
	{ AS(posix_fadvise_args), (sy_call_t *)sys_posix_fadvise, AUE_POSIX_FADVISE, NULL, 0, 0, SYF_PLEDGE_STDIO, SY_THR_STATIC },	/* 531 = posix_fadvise */
	{ AS(wait6_args), (sy_call_t *)sys_wait6, AUE_WAIT6, NULL, 0, 0, 0, SY_THR_STATIC },	/* 532 = wait6 */
	{ AS(cap_rights_limit_args), (sy_call_t *)sys_cap_rights_limit, AUE_CAP_RIGHTS_LIMIT, NULL, 0, 0, SYF_PLEDGE_CAPCOMPAT | SYF_CAPENABLED, SY_THR_STATIC },	/* 533 = cap_rights_limit */
	{ AS(cap_ioctls_limit_args), (sy_call_t *)sys_cap_ioctls_limit, AUE_CAP_IOCTLS_LIMIT, NULL, 0, 0, SYF_PLEDGE_CAPCOMPAT | SYF_CAPENABLED, SY_THR_STATIC },	/* 534 = cap_ioctls_limit */
	{ AS(cap_ioctls_get_args), (sy_call_t *)sys_cap_ioctls_get, AUE_CAP_IOCTLS_GET, NULL, 0, 0, SYF_PLEDGE_CAPCOMPAT | SYF_CAPENABLED, SY_THR_STATIC },	/* 535 = cap_ioctls_get */
	{ AS(cap_fcntls_limit_args), (sy_call_t *)sys_cap_fcntls_limit, AUE_CAP_FCNTLS_LIMIT, NULL, 0, 0, SYF_PLEDGE_CAPCOMPAT | SYF_CAPENABLED, SY_THR_STATIC },	/* 536 = cap_fcntls_limit */
	{ AS(cap_fcntls_get_args), (sy_call_t *)sys_cap_fcntls_get, AUE_CAP_FCNTLS_GET, NULL, 0, 0, SYF_PLEDGE_CAPCOMPAT | SYF_CAPENABLED, SY_THR_STATIC },	/* 537 = cap_fcntls_get */
	{ AS(bindat_args), (sy_call_t *)sys_bindat, AUE_BINDAT, NULL, 0, 0, SYF_PLEDGE_INET | SYF_PLEDGE_UNIX | SYF_PLEDGE_DNS | SYF_PLEDGE_YPACTIVE | SYF_CAPENABLED, SY_THR_STATIC },	/* 538 = bindat */
	{ AS(connectat_args), (sy_call_t *)sys_connectat, AUE_CONNECTAT, NULL, 0, 0, SYF_PLEDGE_INET | SYF_PLEDGE_UNIX | SYF_PLEDGE_DNS | SYF_PLEDGE_YPACTIVE | SYF_CAPENABLED, SY_THR_STATIC },	/* 539 = connectat */
	{ AS(chflagsat_args), (sy_call_t *)sys_chflagsat, AUE_CHFLAGSAT, NULL, 0, 0, SYF_PLEDGE_FATTR | SYF_CAPENABLED, SY_THR_STATIC },	/* 540 = chflagsat */
	...
	{ AS(fdatasync_args), (sy_call_t *)sys_fdatasync, AUE_FSYNC, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 550 = fdatasync */
	{ AS(fstat_args), (sy_call_t *)sys_fstat, AUE_FSTAT, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 551 = fstat */
	{ AS(fstatat_args), (sy_call_t *)sys_fstatat, AUE_FSTATAT, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_PLEDGE_RPATH | SYF_PLEDGE_WPATH | SYF_CAPENABLED, SY_THR_STATIC },	/* 552 = fstatat */
	{ AS(fhstat_args), (sy_call_t *)sys_fhstat, AUE_FHSTAT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 553 = fhstat */
	{ AS(getdirentries_args), (sy_call_t *)sys_getdirentries, AUE_GETDIRENTRIES, NULL, 0, 0, SYF_PLEDGE_RPATH | SYF_CAPENABLED, SY_THR_STATIC },	/* 554 = getdirentries */
	{ AS(statfs_args), (sy_call_t *)sys_statfs, AUE_STATFS, NULL, 0, 0, SYF_PLEDGE_RPATH, SY_THR_STATIC },	/* 555 = statfs */
	{ AS(fstatfs_args), (sy_call_t *)sys_fstatfs, AUE_FSTATFS, NULL, 0, 0, SYF_PLEDGE_RPATH | SYF_CAPENABLED, SY_THR_STATIC },	/* 556 = fstatfs */
	{ AS(getfsstat_args), (sy_call_t *)sys_getfsstat, AUE_GETFSSTAT, NULL, 0, 0, SYF_PLEDGE_RPATH, SY_THR_STATIC },	/* 557 = getfsstat */
	{ AS(fhstatfs_args), (sy_call_t *)sys_fhstatfs, AUE_FHSTATFS, NULL, 0, 0, 0, SY_THR_STATIC },	/* 558 = fhstatfs */
	{ AS(mknodat_args), (sy_call_t *)sys_mknodat, AUE_MKNODAT, NULL, 0, 0, SYF_PLEDGE_DPATH | SYF_CAPENABLED, SY_THR_STATIC },	/* 559 = mknodat */
	{ AS(kevent_args), (sy_call_t *)sys_kevent, AUE_KEVENT, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 560 = kevent */
	...
	{ AS(getrandom_args), (sy_call_t *)sys_getrandom, AUE_NULL, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 563 = getrandom */
	...
	{ AS(funlinkat_args), (sy_call_t *)sys_funlinkat, AUE_UNLINKAT, NULL, 0, 0, SYF_PLEDGE_CPATH | SYF_CAPENABLED, SY_THR_STATIC },	/* 568 = funlinkat */
	{ AS(copy_file_range_args), (sy_call_t *)sys_copy_file_range, AUE_NULL, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 569 = copy_file_range */
	{ AS(__sysctlbyname_args), (sy_call_t *)sys___sysctlbyname, AUE_SYSCTL, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 570 = __sysctlbyname */
	...
	{ AS(close_range_args), (sy_call_t *)sys_close_range, AUE_CLOSERANGE, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 575 = close_range */
	{ AS(rpctls_syscall_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 576 = rpctls_syscall */
	{ AS(unveilctl_args), (sy_call_t *)sys_unveilctl, AUE_UNVEILCTL, NULL, 0, 0, SYF_PLEDGE_UNVEIL, SY_THR_STATIC },	/* 577 = unveilctl */
};
