...
struct sysent sysent[] = {
	...
	{ AS(closefrom_args), (sy_call_t *)sys_closefrom, AUE_CLOSEFROM, NULL, 0, 0, SYF_PLEDGE_STDIO | SYF_CAPENABLED, SY_THR_STATIC },	/* 509 = closefrom */
	...
	{ AS(pledge_args), (sy_call_t *)sys_pledge, AUE_PLEDGE, NULL, 0, 0, SYF_PLEDGE_ALWAYS | SYF_CAPENABLED, SY_THR_STATIC },	/* 574 = pledge */
};
