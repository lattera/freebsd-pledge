...
struct sysent sysent[] = {
	...
	{ AS(open_args), (sy_call_t *)sys_open, AUE_OPEN_RWTC, NULL, 0, 0, SYF_PLEDGE_STDIO, SY_THR_STATIC },	/* 5 = open */
	...
	{ AS(access_args), (sy_call_t *)sys_access, AUE_ACCESS, NULL, 0, 0, SYF_PLEDGE_STDIO, SY_THR_STATIC },	/* 33 = access */
	...
	{ AS(readlink_args), (sy_call_t *)sys_readlink, AUE_READLINK, NULL, 0, 0, SYF_PLEDGE_STDIO, SY_THR_STATIC },	/* 58 = readlink */
	...
	{ AS(openat_args), (sy_call_t *)sys_openat, AUE_OPENAT_RWTC, NULL, 0, 0, SYF_PLEDGE_RPATH | SYF_PLEDGE_WPATH | SYF_CAPENABLED, SY_THR_STATIC },	/* 499 = openat */
	{ AS(readlinkat_args), (sy_call_t *)sys_readlinkat, AUE_READLINKAT, NULL, 0, 0, SYF_PLEDGE_RPATH | SYF_PLEDGE_WPATH | SYF_CAPENABLED, SY_THR_STATIC },	/* 500 = readlinkat */
